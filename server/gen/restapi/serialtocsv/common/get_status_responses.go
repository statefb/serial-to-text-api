...
func (o *GetStatusOK) WithPayload(payload string) *GetStatusOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get status o k response
func (o *GetStatusOK) SetPayload(payload string) {
	o.Payload = payload
}
...
func (o *GetStatusDefault) WithPayload(payload *models.ErrorV1) *GetStatusDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get status default response
func (o *GetStatusDefault) SetPayload(payload *models.ErrorV1) {
	o.Payload = payload
}
